...
export default function RecipeSourceLink({ url, label = 'View original recipe' }: Props) {
  return (
    <a
      href={url}
      target="_blank"
    ...
    >
      <span className="text-115 font-semibold" style={{ color: 'var(--foreground)' }}>{label}</span>
